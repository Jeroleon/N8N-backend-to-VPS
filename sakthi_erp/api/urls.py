...
urlpatterns = [
    ...
    path("delete_programer/<int:product_id>/",views.delete_programer,name="delete_programer"),
    ...
    path("delete_qa/<int:product_id>/",views.delete_qa,name="delete_qa"),
    ...
    path("update_acc_details/<int:product_id>/",views.update_acc_details,name="update_acc_details"),
    path("delete_acc/<int:product_id>/",views.delete_acc,name="delete_acc"),
    ...
    path("export_specific_details/",views.export_specific_details,name="export_specific_details"),
